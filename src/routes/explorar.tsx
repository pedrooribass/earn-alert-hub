...
import { offerPresentation, opportunities } from "@/lib/opportunities";
...
function ExplorePage() {
 ...
 const filtered=useMemo(()=>opportunities.filter(i=>{const content=offerPresentation[i.id];return content?.discovery.includes(category)&&(i.brand+" "+content.title+" "+content.summary).toLowerCase().includes(query.toLowerCase())}),[query,category]);
