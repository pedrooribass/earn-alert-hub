...
const pt: Record<string, OfferContent> = {
  ...
  "trading212-acao": {
    ...
    eligibility: ["Cliente novo", "Maior de 18 anos", "Verificação de identidade com documento"],
    risks: [
      "A esmagadora maioria das ações atribuídas fica perto do valor mínimo. Os 100€ são o topo do intervalo, não o que é de esperar.",
      "A ação é um investimento: o valor sobe e desce, e o que recebes hoje pode valer menos quando venderes.",
      "Investir comporta risco e podes perder o capital investido.",
    ],
...
const de: Record<string, OfferContent> = {
  ...
  "trading212-acao": {
    ...
    eligibility: ["Neukunde", "Mindestens 18 Jahre alt", "Identitätsprüfung mit Ausweis"],
    risks: [
      "Die allermeisten zugeteilten Aktien liegen nahe am Mindestwert. Die 100 € sind das obere Ende der Spanne, nicht der Erwartungswert.",
      "Die Aktie ist eine Geldanlage: Ihr Wert schwankt, und was du heute bekommst, kann beim Verkauf weniger wert sein.",
      "Geldanlage ist mit Risiko verbunden und kann zum Verlust des eingesetzten Kapitals führen.",
    ],
