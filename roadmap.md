...
- [ ] Migrar ofertas para dados verificáveis e bloquear ações com capital desconhecido.
- [ ] Tornar verificação, comissões, risco e financiamento da aplicação transparentes.
- [ ] Criar Informação legal e a vista interna de verificações pendentes.
